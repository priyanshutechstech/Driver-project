package com.techsteck.techtaxii

import com.techsteck.techtaxii.ChatHeadService
...
class MainActivity : FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        channel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.techsteck.techtaxii")
